  ...
  return (
    <section id="testimonials" className="py-20 bg-gray-50 relative overflow-hidden">
      <div className="container mx-auto px-4">
        ...
        <p className='text-center text-gray-600 mb-4 mt-0'>
          Nous sommes fiers de vous
          témoigner de la fiabilité de nos service et de 
          l’efficacité de nos techniciens
        </p>
          ...
          <div className="overflow-hidden">
            <div className="flex transition-transform duration-500 ease-in-out">
              {getVisibleTestimonials().map((testimonial, index) => (
                <div 
                  key={index}
                  className="w-1/3 flex-shrink-0 px-4 transform transition-opacity duration-300"
                >
