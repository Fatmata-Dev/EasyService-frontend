...
export default function LoginModal({
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Supprimez les redirections conditionnelles ici
      // Laissez AuthProvider gérer cela
      window.location.reload(); // Force le re-render pour que AuthProvider prenne le relais
