        ...
        <div className="py-4 container max-w-xl mx-auto">
          <div className="bg-gray-100 py-4">
            ...
            <div className="mx-12">
              ...
              <div className="mb-4">
                <label htmlFor="nom" className="block font-medium text-gray-900">
                  Prénom et nom
                </label>
                <div className="mt-2">
                  <input
              ...
              <div className="mb-4">
                <label htmlFor="mail" className="block font-medium text-gray-900">
                  Email
                </label>
                <div className="mt-2">
                  <input
              ...
              <div className="mt-6 flex items-center justify-end gap-x-6">
                <button
                  type="submit"
                  disabled={isLoading}
                  className="rounded-md bg-orange-500 mt-4 px-3 py-2 text-xl w-full font-semibold text-white shadow-xs hover:bg-orange-600 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-orange-700 disabled:opacity-50"
                >
